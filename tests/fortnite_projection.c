...
int main(void) {
    ...
    assert(EmberFnProjectWorldPoint(player, origin, 0, 0, 0, 90, 1000, 500, &x, &y));
    ...
    assert(EmberFnProjectWorldPoint(player, origin, 0, 20, 0, 90, 1000, 500, &x, &y));
    assert(x < 500);
